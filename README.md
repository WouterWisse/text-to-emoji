<div align="center">
   <img width="600" src="https://github.com/WouterWisse/text-to-emoji/blob/main/.github/assets/logo-light@2x.png?raw=true#gh-light-mode-only" alt="Text To Emoji - Logo">
   <img width="600" src="https://github.com/WouterWisse/text-to-emoji/blob/main/.github/assets/logo-dark@2x.png?raw=true#gh-dark-mode-only" alt="Text To Emoji - Logo">
</div>
